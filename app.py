...
st.markdown("""
    ...
    /* Rimuove decorazioni Streamlit in alto */
...
with tab2:
    st.markdown("<div class='card'><h3>Osservatorio Scientifico</h3><p>Monitoraggio in tempo reale dei database medici mondiali (PubMed / Harvard).</p></div>", unsafe_allow_html=True)
    c1, c2 = st.columns(2)
    with c1:
...
with tab3:
    st.markdown("""<div class='card'>
        ...
        <a href='https://www.iayt.org/' target='_blank' style='color:#C5A059; text-decoration:none; font-weight:bold;'>Accedi al Database Clinico →</a>
    </div>""", unsafe_allow_html=True)
